...
def alarm_clock(day, vacation):
    if day > 0 and day < 7 and vacation == False:
        return '7:00'
    elif day == 0 or day == 7 and vacation == False:
        return '10:00'
    elif day > 0 and day < 7 and vacation == True:
        return '10:00'
    elif day == 0 or day == 7 and vacation == True:
        return 'off'
